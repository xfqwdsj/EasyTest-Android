...
import xyz.xfqlittlefan.easytest.databinding.ActivityResult2Binding
                    ...
                    override fun onNext(result: AVObject) {
                        ...
                        queryUser.getInBackground(result.get("userid") as String).subscribe(object : Observer<AVObject> {
                            ...
                            override fun onNext(user: AVObject) {
                                ...
                                binding.textView.text = this@ResultActivity2.resources.getString(R.string.result_text_uploaded, nickname, username, unit, getTime(time), help.toString(), checkCustomHelp(customHelp), createdAt, updatedAt)
                                binding.toolbar.title = this@ResultActivity2.resources.getString(R.string.result_title, nickname)
                            ...
                            override fun onError(e: Throwable) {
                                BottomDialog().create(this@ResultActivity2).apply {
                                    setTitle(R.string.failed)
                                    setContent(this@ResultActivity2.resources.getString(R.string.error, e))
                                    setButton1(android.R.string.ok) {
                                        close()
                                    }
                                }
                    ...
                    if (result.save()) {
                        BottomDialog().create(this@ResultActivity2).apply {
                            ...
                            setButton1(android.R.string.ok) {
                                close()
                                finish()
                                Intent(this@ResultActivity2, ResultActivity2::class.java).apply {
